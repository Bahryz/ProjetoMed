...
// --- Telas Principais e de Navegação ---
...
class AppRouter {
  ...
  late final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: '/documentos', builder: (context, state) => const DocumentosScreen()),
      ...
      GoRoute(path: '/meus-agendamentos', builder: (context, state) => const MeusAgendamentosScreen()),
      GoRoute(path: '/paciente-conteudo-educativo', builder: (context, state) => const PacienteConteudoEducativoScreen()),
